<template>
    <div class="w-full px-5 my-10 mx-auto xl:w-1/2">
        ...
        <p>Berufsbezeichnung: Staatlich geprüfter Techniker<br>
        ...
        <h2 class="text-2xl my-5">Streitschlichtung</h2>
        ...
        <h3 class="text-xl my-3">Haftung für Inhalte</h3>
        ...
        <h3 class="text-xl my-3">Haftung für Links</h3>
        ...
        <h3 class="text-xl my-3">Urheberrecht</h3>
