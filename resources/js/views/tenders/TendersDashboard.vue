<template>
    ...
    <section>
        ...
        <card class="flex flex-col overflow-hidden px-0"> 
           ...
           <p class="flex px-5 py-5 md:px-10 text-gray-500" v-show="!tenders">
...
<script> 
    import TenderDashboardCard from './TenderDashboardCard';
