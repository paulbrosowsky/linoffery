    ...
    <section>
        <div class="mb-5">
            <p class="text-xl text-teal-500">
                {{ $t('auth.almost_finished') }}
            </p>
            <p class="text-gray-700">
                <span>{{ $t('auth.signup_info') }}</span>               
            </p>
        </div>

        <div class="text-gray-700 mb-5">
            <span>{{ $t('auth.privacy_info') }}</span>
...
<script>
    export default {
        ...
        computed:{           
            ...
            buttonClasses(){
                if(!this.complete){
                    return 'btn btn-teal w-full ml-5 opacity-25 cursor-not-allowed';
                }                
                return 'btn btn-teal w-full ml-5';
            }
        }
